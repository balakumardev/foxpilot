...
/**
 * Whether the console-capture scripts should be injected.
 *
 * Capture requires BOTH Automation Mode and its own opt-in. It is deliberately
 * NOT implied by Automation Mode: the capture registration is the most invasive
 * injection the scripting API allows (MAIN world, all URLs, all frames,
 * document_start) and the injected wrapper replaces
...
export interface ExtensionConfig {
   ...
   * Absent/false — the default — means the capture scripts are never registered,
