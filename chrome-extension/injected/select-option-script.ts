 ...
 * content-script.ts. MUST stay fully self-contained: inner helpers only, no
 * imports / module refs (guarded by self-containment.test.ts). Async is preserved
 * by esbuild(esnext) and the ES2022 tsconfig — no __awaiter/__generator helper
 * appears in .toString().
 */
